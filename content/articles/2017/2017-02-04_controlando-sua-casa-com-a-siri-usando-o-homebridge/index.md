...
- Crie o arquivo **homebridge** dentro de **/etc/default** e copie o conteúdo a seguir, você pode usar o **nano** como já usamos anteriormente.`# Configuration options for homebridge
