...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/1.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/2.png)
...
` mkdir myproject cd myproject``# Create a virtual environment to isolate our package dependencies locally python3 -m venv env source env/bin/activate``# Install Django and Django REST framework into the virtual environment pip install django djangorestframework``# Install database specific libraries for the project, in this case PostgresSQL and Bigquery pip install google-cloud-bigquery psycopg2``# Additional libraries to run the project and serve static files pip install gunicorn whitenoise``# Set up a new project with a single application django-admin startproject myproject . django-admin startapp tank_monitoring``# Freeze dependencies to be used on the Docker container pip freeze &gt; requirements.txt `
...
[alvarowolfx/cloud-run-django-rest-iot](https://github.com/alvarowolfx/cloud-run-django-rest-iot/blob/master/tank_monitoring/models.py)
...
[alvarowolfx/cloud-run-django-rest-iot](https://github.com/alvarowolfx/cloud-run-django-rest-iot/blob/master/tank_monitoring/services.py)

[alvarowolfx/cloud-run-django-rest-iot](https://github.com/alvarowolfx/cloud-run-django-rest-iot/blob/master/tank_monitoring/views.py)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/3.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/4.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/5.png)

![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/6.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/7.png)
...
`export DB_USER=[DB_USER] export DB_PASS=[DB_PASS] export DB_NAME=[DB_PASS] export DB_CONNECTION_NAME=[DB_CONNECTION_NAME] export GCLOUD_PROJECT=[YOUR_PROJECT_NAME] gcloud beta run deploy --image gcr.io/[YOUR_PROJECT_NAME]/tank-monitoring \ —add-cloudsql-instances $DB_CONNECTION_NAME \ —set-env-vars GCLOUD_PROJECT=$GCLOUD_PROJECT \ —set-env-vars DB_CONNECTION_NAME=$DB_CONNECTION_NAME \ —set-env-vars DB_USER=$DB_USER \ —set-env-vars DB_PASS=$DB_PASS \ —set-env-vars DB_NAME=$DB_PASS`
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/8.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/9.png)

Also, a REST API is available to we can build an app for example accessing our data our farms, tanks and devices data.

![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/10.png)
...
![image](/articles/2020/2020-01-06_iot-tank-monitoring-solution-part-1build-a-rest-api-using-cloud-run-and-django-rest-framework/images/11.png)
